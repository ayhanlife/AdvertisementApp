...
namespace AdvertisementApp.Bussniess.ValidationRules.FluentValidations.AdvertisementAppUser
{
    public class AdvertisementAppUserCreateDtoValidator : AbstractValidator<AdvertisementAppUserCreateDto>
    {
        public AdvertisementAppUserCreateDtoValidator()
        {
            ...
            this.RuleFor(x => x.CvPath).NotEmpty().WithMessage("Bir cv dosyası giriniz.");
