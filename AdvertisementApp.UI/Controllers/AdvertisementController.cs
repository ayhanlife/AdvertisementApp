...
namespace AdvertisementApp.UI.Controllers
{
    public class AdvertisementController : Controller
    {
        ...
        {
            return View(await _advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Basvuruldu));
        }
        ...
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> ApprovedList(int advertisementAppUserId, AdvertisementAppUserStatusType type)
        {
            return View(await _advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Mulakat));
        }

        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> RejectedList(int advertisementAppUserId, AdvertisementAppUserStatusType type)
        {
            return View(await _advertisementAppUserService.GetList(AdvertisementAppUserStatusType.Olumsuz));
        }
    }
}
